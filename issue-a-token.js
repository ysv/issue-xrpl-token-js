...
async function main() {
  ...
  // CHANGE HERE:
  const hot_wallet = xrpl.Wallet.fromSeed("sEdVFXHTXfnYq6FMjtbRAXsERGMGSQS") // r4Txe7gLghmKXcENfDWnGNZGykSVZsses5
  const cold_wallet = xrpl.Wallet.fromSeed("sEd7B2XdeebikvnnmMiGeF6kf9eWfuF") // rEdFASKE6bh66L418ZpRfwWQvJVBXSiFhS
  const customer_one_wallet = xrpl.Wallet.fromSeed("sEdVjqH8cQabb3JzpYd3Dz7iuDZdQXZ") // rBrsMTk9pFwzJzwK4CPKWnC3efGLMCjRzg
  const customer_two_wallet = xrpl.Wallet.fromSeed("sEd7c1WHjpnFrjuH86MjgmTbM6hNzRc") // rEBnV9oBQs7kX4w6QQVp3upar7n3gD3oQv
  //
